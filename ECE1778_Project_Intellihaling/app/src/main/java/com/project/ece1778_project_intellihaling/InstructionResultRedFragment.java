...
public class InstructionResultRedFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_instruction_red, container, false);

        CurrentTimeView = (TextView)view.findViewById(R.id.instruction_red_time);
        inhaleCount = (TextView)view.findViewById(R.id.instruction_red_text_count_view);
        startBtn = (Button)view.findViewById(R.id.btn_instruction_red_time_count);
